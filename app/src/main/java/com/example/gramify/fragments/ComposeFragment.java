...
import com.example.gramify.BitmapScaler;
import com.example.gramify.LoginActivity;
import com.example.gramify.MainActivity;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        eTextDescription = view.findViewById(R.id.etDescription);
        ...
        postButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (photoFile == null || imagePreview.getDrawable() == null) {
                    ...
                    Toast.makeText(getContext(), "You're missing a photo", Toast.LENGTH_SHORT).show();
                    return;
                }
